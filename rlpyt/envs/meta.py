...
def make(env_id='sweeper', info_example=None, **kwargs):
    ...
    if info_example is None:
        return MetaEnvWrapper(TimeLimit(make(), max_episode_steps=1000))
    else:
        return MetaEnvWrapper(EnvInfoWrapper(
            TimeLimit(make(), max_episode_steps=1000), info_example))
